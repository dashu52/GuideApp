    ...
    public GuideLineEntity getGuideLineData(GuideLineEntity guideLineEntity){
        ...
        for (LocationEntity entity:locationEntityList) {
            ...
            if(mediaResourceEntity!=null){
                List<MotionEntity> motionEntityList = AppDataBase.get().getMotionDao().getMotionListFor(mediaResourceEntity.id);
                entity.mMediaResourceEntity.mMotionList = motionEntityList;
            }
        }
        return guideLineEntity;
    }
